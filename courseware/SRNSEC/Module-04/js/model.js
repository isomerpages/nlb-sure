...
function loadXML()
{
	...
	//Page Title 	
	pagesArr.push({pageId:"m01_040_010_010.html",pageType:"conceptual",pageTitle:"A Scenario",hasAudio:0});		
	pagesArr.push({pageId:"m01_040_010_020.html",pageType:"conceptual",pageTitle:"Lesson Outline",hasAudio:1});	
	pagesArr.push({pageId:"m01_040_010_030.html",pageType:"conceptual",pageTitle:"Skimming and Scanning for Information",hasAudio:0});	
	pagesArr.push({pageId:"m01_040_010_040.html",pageType:"conceptual",pageTitle:"Extracting Information",hasAudio:0});	
	pagesArr.push({pageId:"m01_040_010_050.html",pageType:"conceptual",pageTitle:"Skimming for Information",hasAudio:0});
	pagesArr.push({pageId:"m01_040_010_060.html",pageType:"conceptual",pageTitle:"Skimming Exercise",hasAudio:0});	
	pagesArr.push({pageId:"m01_040_010_070.html",pageType:"conceptual",pageTitle:"Scanning for Information",hasAudio:0});
	pagesArr.push({pageId:"m01_040_010_080.html",pageType:"conceptual",pageTitle:"Scanning Exercise",hasAudio:0});	
	pagesArr.push({pageId:"m01_040_010_090.html",pageType:"conceptual",pageTitle:"Using the Extracted Information" ,hasAudio:0});
	pagesArr.push({pageId:"m01_040_010_100.html",pageType:"conceptual",pageTitle:"Note-Taking and Paraphrasing" ,hasAudio:0});

	pagesArr.push({pageId:"m01_040_010_110.html",pageType:"conceptual",pageTitle:"Paraphrasing Exercise" ,hasAudio:0});
	pagesArr.push({pageId:"m01_040_010_120.html",pageType:"conceptual",pageTitle:"Cite Your Sources" ,hasAudio:0});
	pagesArr.push({pageId:"m01_040_010_130.html",pageType:"conceptual",pageTitle:"Activity 1 - Question 1" ,hasAudio:1});
	pagesArr.push({pageId:"m01_040_010_130a.html",pageType:"conceptual",pageTitle:"Activity 1 - Question 2" ,hasAudio:0});
	pagesArr.push({pageId:"m01_040_010_130b.html",pageType:"conceptual",pageTitle:"Activity 1 - Question 3" ,hasAudio:0});
	pagesArr.push({pageId:"m01_040_010_130c.html",pageType:"conceptual",pageTitle:"Activity 1 - Question 4" ,hasAudio:0});
	pagesArr.push({pageId:"m01_040_010_130d.html",pageType:"conceptual",pageTitle:"Activity 1 - Question 5" ,hasAudio:0});
	
	pagesArr.push({pageId:"m01_040_010_140.html",pageType:"conceptual",pageTitle:"Activity 2",hasAudio:0});	
	pagesArr.push({pageId:"m01_040_010_150.html",pageType:"conceptual",pageTitle:"A Project Well Done",hasAudio:0});	
	pagesArr.push({pageId:"m01_040_010_160.html",pageType:"last",pageTitle:"Summary",hasAudio:1});	
