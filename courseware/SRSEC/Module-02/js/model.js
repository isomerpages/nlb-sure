...
function loadXML()
{
	...
	//Module Title 
	tempModule.push("Structure of a Research Report - Part 1");
	
	//Page Title 	
	pagesArr.push({pageId:"m01_020_010_010.html#slide-1-1",pageType:"conceptual",pageTitle:"Introduction",hasAudio:1});
	pagesArr.push({pageId:"m01_020_010_020.html#slide-1-1",pageType:"conceptual",pageTitle:"Introduction (Cont'd)",hasAudio:1});
	pagesArr.push({pageId:"m01_020_010_030.html#slide-1-1",pageType:"conceptual",pageTitle:"Introduction (Cont'd)",hasAudio:1});	
	pagesArr.push({pageId:"m01_020_010_040.html#slide-1-1",pageType:"conceptual",pageTitle:"Introduction (Cont'd)",hasAudio:1});
	pagesArr.push({pageId:"m01_020_010_050.html#slide-1-1",pageType:"conceptual",pageTitle:"Lesson Outline",hasAudio:1});
	pagesArr.push({pageId:"m01_020_010_060.html#slide-1-1",pageType:"conceptual",pageTitle:"The Research Methods Section",hasAudio:1});
	pagesArr.push({pageId:"m01_020_010_070.html#slide-1-1",pageType:"conceptual",pageTitle:"Writing the Research Methods Section",hasAudio:0});
	pagesArr.push({pageId:"m01_020_010_080.html#slide-1-1",pageType:"conceptual",pageTitle:"Summary of the Research Methods Section",hasAudio:0});
	pagesArr.push({pageId:"m01_020_010_090.html#slide-1-1",pageType:"conceptual",pageTitle:"Activity 1 - Question 1",hasAudio:1});
	pagesArr.push({pageId:"m01_020_010_090a.html#slide-1-1",pageType:"conceptual",pageTitle:"Activity 1 - Question 2",hasAudio:0});
	pagesArr.push({pageId:"m01_020_010_090b.html#slide-1-1",pageType:"conceptual",pageTitle:"Activity 1 - Question 3",hasAudio:0});
	pagesArr.push({pageId:"m01_020_010_100.html#slide-1-1",pageType:"conceptual",pageTitle:"The Findings Section",hasAudio:1});
	pagesArr.push({pageId:"m01_020_010_110.html#slide-1-1",pageType:"conceptual",pageTitle:"The Findings Section (Cont'd)",hasAudio:1});
	pagesArr.push({pageId:"m01_020_010_120.html#slide-1-1",pageType:"conceptual",pageTitle:"Presenting the Results and Stating the Findings",hasAudio:1});
	pagesArr.push({pageId:"m01_020_010_130.html#slide-1-1",pageType:"conceptual",pageTitle:"Presenting the Results and Stating the Findings (Cont'd)",hasAudio:0});
	pagesArr.push({pageId:"m01_020_010_140.html#slide-1-1",pageType:"conceptual",pageTitle:"The Findings Section - Summary",hasAudio:0});
	pagesArr.push({pageId:"m01_020_010_150.html#slide-1-1",pageType:"conceptual",pageTitle:"Activity 2",hasAudio:1});
	pagesArr.push({pageId:"m01_020_010_160.html#slide-1-1",pageType:"last",pageTitle:"Summary",hasAudio:1});
